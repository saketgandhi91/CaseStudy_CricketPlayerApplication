...
public class PlayerControllerTest 
{
	...
	@Test
	public void addPlayerControllerTest() throws Exception 
	{	
		when(ar.addPlayer(any())).thenReturn(pt);
		mockmvc.perform(post("/api/v1/play")
				.contentType(MediaType.APPLICATION_JSON)
				.content(asJSONString(pt)))
				.andExpect(status().isCreated());
		verify(ar,times(1)).addPlayer(any());	
	}
